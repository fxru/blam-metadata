# Basic Language Archive Metadata
...
* BLAM Bundle Repository: described in this document [below](#the-profile)
...
## The Profile: BLAM Bundle Repository {#the-profile}
...
**Description:** &#x1F4CC; The BundleID element contains an identifier that consistently and uniquely identifies the bundle described in the particular metadata token. The identifier should be a PID and is usually generated by the repository during the ingest process.
	...
	CCR URI:                	hdl.handle.net—CCR_C-2544_3626545e-a21d-058c-ebfd-241c0464e7e5 <http://hdl.handle.net/11459/CCR_C-2544_3626545e-a21d-058c-ebfd-241c0464e7e5>
...
[Back to Top](#the-profile) | [Back to BundleGeneralInfo](#bundlegeneralinfo)
...
**Description:** &#x1F4A5; &#x1F4CC; The BundleDisplayTitle element provides a human readable name of the bundle. It should contain a meaningful and recognisable title for the bundle. The content of the BundleDisplayTitle element will be used as the human readable identifier in interfaces. Data providers can provide BundleDisplayTitle values for multiple interface languages.
	...
	CCR URI:                	hdl.handle.net—CCR_C-2545_d873f2ab-2a2f-29d6-a9ab-260cde57f227 <http://hdl.handle.net/11459/CCR_C-2545_d873f2ab-2a2f-29d6-a9ab-260cde57f227>
...
**Description:** &#x1F4A5; &#x1F4CC; The BundleRecordingDate element contains the date at which a recording occured. The date must be provided conforming to ISO 8601 in the form YYYY-MM-DD, YYYY-MM, or YYYY
	...
	CCR URI:                	hdl.handle.net—CCR_C-5257_6572a4ea-cc70-c721-bbd8-2f6c28cc71a1 <http://hdl.handle.net/11459/CCR_C-5257_6572a4ea-cc70-c721-bbd8-2f6c28cc71a1>
...
[Back to Top](#the-profile) | [Back to BundlePublicationInfo](#bundlepublicationinfo)
...
[Back to Top](#the-profile) | [Back to ProjectInfo](#projectinfo)
...
[Back to Top](#the-profile) | [Back to BundleDataInfo](#bundledatainfo)
...
[Back to Top](#the-profile) | [Back to BundleAdministrativeInfo](#bundleadministrativeinfo)
...
[Back to Top](#the-profile) |  [Back to BundleStructuralInfo](#bundlestructuralinfo)
